...
Public Class frmFpMain
    Dim tmpCID As String = ""

    Private Sub frmFpMain_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'ClearData()
    ...
    Private Sub ShowDataFp()
        ...
        ds = clsdataBus.Lc_Business.SELECT_TABLE("a.PID,a.ROWID,a.HOSPCODE,a.SEQ,a.DATE_SERV,a.FPTYPE,a.FPPLACE,a.AMOUNT,b.FP_DESC," _
                                                 & "a.PROVIDER,a.D_UPDATE,a.STATUS_AF" _
                                                 , "m_fp a  LEFT JOIN l_fptype b on(a.FPTYPE = b.FP_CODE)" _
    ...
    Private Sub DisplayData(ByVal ds As DataSet)
        ...
        Try
            ...
            For i As Integer = 0 To ds.Tables(0).Rows.Count - 1
                ...
                BetterListView1.Items(i).SubItems.Add((dr("FPTYPE")).ToString).AlignHorizontal = TextAlignmentHorizontal.Center
                BetterListView1.Items(i).SubItems.Add((dr("FP_DESC")).ToString).AlignHorizontal = TextAlignmentHorizontal.Center
                ...
                BetterListView1.Items(i).SubItems.Add(clsdataBus.Lc_Business.SELECT_NAME_HOSPITAL(dr("FPPLACE")).ToString).AlignHorizontal = TextAlignmentHorizontal.Left
    ...
    Private Sub BetterListView1_DoubleClick(sender As Object, e As EventArgs) Handles BetterListView1.DoubleClick
        For i As Integer = 0 To BetterListView1.SelectedItems.Count - 1
            ...
            vFpRowID = lvi.SubItems.Item(1).Text
        Next
