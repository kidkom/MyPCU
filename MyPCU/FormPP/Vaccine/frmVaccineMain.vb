...
Public Class frmVaccineMain
    ...
    Private Sub ShowDataVaccine()
        ...
        ds = clsdataBus.Lc_Business.SELECT_TABLE("a.PID,a.ROWID,a.HOSPCODE,a.SEQ,a.DATE_SERV,a.VACCINETYPE,a.VACCINEPLACE,d.VACCINE_DESC_E," _
                                                 ...
                                                 , "m_epi a JOIN m_person p ON(a.PID = p.PID) LEFT JOIN l_vaccinetype d ON(a.VACCINETYPE = d.VACCINE_CODE)" _
    ...
    Private Sub DisplayData(ByVal ds As DataSet)
        ...
        Try
            ...
            For i As Integer = 0 To ds.Tables(0).Rows.Count - 1
                ...
                BetterListView1.Items(i).SubItems.Add((dr("VACCINETYPE")).ToString).AlignHorizontal = TextAlignmentHorizontal.Center
                BetterListView1.Items(i).SubItems.Add((dr("VACCINE_DESC_E")).ToString).AlignHorizontal = TextAlignmentHorizontal.Center
