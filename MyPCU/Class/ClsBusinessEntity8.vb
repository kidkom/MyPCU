...
Imports System.Text
Public Class ClsBusinessEntity8
    Public Shared Lc_BusinessEntity8 As New ClsBusinessEntity8
    ...
    Private Function CommExecuteTrans(ByVal SqlStr As String) As Boolean
        ...
        Try
            ...
            Else
                'สำหรับ MySql
                Lc_myTr_MySql = clsdataAcc8.G_ConnMDB_MySql8.BeginTransaction()
                Lc_myComm_MySql = New MySqlCommand
                Lc_myComm_MySql.Transaction = Lc_myTr_MySql
                With Lc_myComm_MySql
                    .CommandText = SqlStr
                    .CommandType = CommandType.Text
                    .Connection = clsdataAcc8.G_ConnMDB_MySql8
                    .ExecuteNonQuery()
                End With
