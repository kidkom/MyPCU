...
Imports System.Text
Public Class ClsBusinessEntity6
    Public Shared Lc_BusinessEntity6 As New ClsBusinessEntity6
    ...
    Private Function CommExecuteTrans(ByVal SqlStr As String) As Boolean
        ...
        Try
            ...
            Else
                'สำหรับ MySql
                Lc_myTr_MySql = clsdataAcc6.G_ConnMDB_MySql6.BeginTransaction()
                Lc_myComm_MySql = New MySqlCommand
                Lc_myComm_MySql.Transaction = Lc_myTr_MySql
                With Lc_myComm_MySql
                    .CommandText = SqlStr
                    .CommandType = CommandType.Text
                    .Connection = clsdataAcc6.G_ConnMDB_MySql6
                    .ExecuteNonQuery()
                End With
