...
Imports clsdataAcc = MyPCU.ClsDataAccess3
Imports clsdataBus = MyPCU.ClsBusiness3
Imports MySql.Data.MySqlClient
Imports System.Text
Public Class ClsBusinessEntity3
    Public Shared Lc_BusinessEntity3 As New ClsBusinessEntity3
    ...
    Private Function CommExecuteTrans(ByVal SqlStr As String) As Boolean
        ...
        Try
            If clsdataAcc.Lc_DataAcc3.getDB_Conn_db3() <> True Then        'เช็คการติดต่อฐานข้อมูลว่าติดต่อได้หรือไม่ True = ติดต่อได้ False = ติดต่อไม่ได้
                v_Resulte = False
            Else
                'สำหรับ MySql
                Lc_myTr_MySql = clsdataAcc.G_ConnMDB_MySql3.BeginTransaction()
                Lc_myComm_MySql = New MySqlCommand
                Lc_myComm_MySql.Transaction = Lc_myTr_MySql
                With Lc_myComm_MySql
                    .CommandText = SqlStr
                    .CommandType = CommandType.Text
                    .Connection = clsdataAcc.G_ConnMDB_MySql3
                    .ExecuteNonQuery()
                End With
    ...
    Public Function Insertm_table(ByVal strTable As String, ByVal strValues As String) As Boolean
        ...
        Return v_Resulte
    End Function
    Public Function Insertm_table2(ByVal strTable As String, ByVal strValues As String) As Boolean
        Dim v_Resulte As Boolean = False
        Try
            Lc_sb = New StringBuilder
            'สำหรับ MySql
