...
Imports clsdataAcc = MyPCU.ClsDataAccess4
Imports clsdataBus = MyPCU.ClsBusiness4
Imports MySql.Data.MySqlClient
Imports System.Text
Public Class ClsBusinessEntity4
    Public Shared Lc_BusinessEntity4 As New ClsBusinessEntity4
    ...
    Private Function CommExecuteTrans(ByVal SqlStr As String) As Boolean
        ...
        Try
            If clsdataAcc.Lc_DataAcc4.getDB_Conn_db4() <> True Then        'เช็คการติดต่อฐานข้อมูลว่าติดต่อได้หรือไม่ True = ติดต่อได้ False = ติดต่อไม่ได้
                v_Resulte = False
            Else
                'สำหรับ MySql
                Lc_myTr_MySql = clsdataAcc.G_ConnMDB_MySql4.BeginTransaction()
                Lc_myComm_MySql = New MySqlCommand
                Lc_myComm_MySql.Transaction = Lc_myTr_MySql
                With Lc_myComm_MySql
                    .CommandText = SqlStr
                    .CommandType = CommandType.Text
                    .Connection = clsdataAcc.G_ConnMDB_MySql4
                    .ExecuteNonQuery()
                End With
