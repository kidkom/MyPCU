...
Public Class frmTableBudget

    Private Sub frmTableBudget_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub searchData()
        ...
        If chkActive.Checked = True Then
            ds = clsdataBus.Lc_Business8.SELECT_TABLE("*", "l_recieve ", " WHERE STATUS_AF = '1' ORDER BY RECIEVECODE+0 ")
        ElseIf chkNonActive.Checked = True Then
            ds = clsdataBus.Lc_Business8.SELECT_TABLE("*", "l_recieve ", " WHERE STATUS_AF = '0' ORDER BY RECIEVECODE+0 ")
        Else
            ds = clsdataBus.Lc_Business8.SELECT_TABLE("*", "l_recieve ", "  ORDER BY RECIEVECODE+0 ")
        End If
    ...
    Private Sub BetterDisplayData(ByVal ds As DataSet)
        ...
        Try
            ...
            For i As Integer = 0 To ds.Tables(0).Rows.Count - 1
                ...
                BetterListView1.Items.Add(dr("RECIEVECODE").ToString).AlignHorizontal = TextAlignmentHorizontal.Center

                BetterListView1.Items(i).SubItems.Add(dr("RECIEVENAME").ToString).AlignHorizontal = TextAlignmentHorizontal.Left
    ...
    Private Sub cmdEdit_Click(sender As Object, e As EventArgs) Handles cmdEdit.Click
        ...
        If CheckBox1.Checked = True Then
            tmpStatus = "0"
        End If
        clsbusent.Lc_BusinessEntity8.UpdateM_table("l_recieve", "RECIEVENAME = '" & txtDesc.Text & "',STATUS_AF = '" & tmpStatus & "'", "RECIEVECODE = '" & txtCode.Text & "'")
        ClearData()
        searchData()
    End Sub
    ...
    Private Sub cmdAdd_Click(sender As Object, e As EventArgs) Handles cmdAdd.Click
        ...
        Dim ds As DataSet
        ds = clsdataBus.Lc_Business8.SELECT_TABLE("*", "l_recieve ", " WHERE  RECIEVECODE = '" & txtCode.Text & "' ")
        If ds.Tables(0).Rows.Count > 0 Then
        ...
        Try
            clsbusent.Lc_BusinessEntity8.InsertM_table("l_recieve (RECIEVECODE,RECIEVENAME,STATUS_AF)",
