...
Public Class frmTableAssetsGroup

    Private Sub frmTableAssetsGroup_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub searchData()
        ...
        If chkActive.Checked = True Then
            ds = clsdataBus.Lc_Business8.SELECT_TABLE("*", "l_group ", " WHERE STATUS_AF = '1' ORDER BY GroupCode ")
        ElseIf chkNonActive.Checked = True Then
            ds = clsdataBus.Lc_Business8.SELECT_TABLE("*", "l_group ", " WHERE STATUS_AF = '0' ORDER BY GroupCode ")
        Else
            ds = clsdataBus.Lc_Business8.SELECT_TABLE("*", "l_group ", "  ORDER BY GroupCode ")
        End If
    ...
    Private Sub cmdEdit_Click(sender As Object, e As EventArgs) Handles cmdEdit.Click
        ...
        If CheckBox1.Checked = True Then
            tmpStatus = "0"
        End If
        clsbusent.Lc_BusinessEntity8.UpdateM_table("l_group", "GroupName = '" & txtDesc.Text & "',STATUS_AF = '" & tmpStatus & "'", "GroupCode = '" & txtCode.Text & "'")
        ClearData()
        searchData()
    End Sub
    ...
    Private Sub cmdAdd_Click(sender As Object, e As EventArgs) Handles cmdAdd.Click
        ...
        If txtCode.Text.Length < 4 Then
            XtraMessageBox.Show("กรุณากำหนดรหัสรายการที่ต้องการบันทึกให้ครบ 4 หลักก่อน!!!", vProgram, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            txtCode.Select()
            Exit Sub
        End If
        If txtDesc.Text = "" Then
        ...
        Dim ds As DataSet
        ds = clsdataBus.Lc_Business8.SELECT_TABLE("*", "l_group ", " WHERE  GroupCode = '" & txtCode.Text & "' ")
        If ds.Tables(0).Rows.Count > 0 Then
        ...
        Try
            clsbusent.Lc_BusinessEntity8.InsertM_table("l_group (GroupCode,GroupName,STATUS_AF)",
