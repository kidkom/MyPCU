...
Public Class frmTableAssetType

    Private Sub frmTableAssetType_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        With BetterListView1
            ...
            .Columns.Add(3).Text = "อายุการใช้งาน"
            .Columns(3).Width = 100
    ...
    Private Sub searchData()
        Dim ds As DataSet
        Dim tmpSEQL As String = ""
        If chkActive.Checked = True Then
            ds = clsdataBus.Lc_Business8.SELECT_TABLE("*", "l_assets_type ", "WHERE STATUS_AF = '1'  ORDER BY ASSETCODE+0 ")
        ElseIf chkNonActive.Checked = True Then
            ds = clsdataBus.Lc_Business8.SELECT_TABLE("*", "l_assets_type ", "WHERE STATUS_AF = '0'   ORDER BY ASSETCODE+0 ")
        Else
            ds = clsdataBus.Lc_Business8.SELECT_TABLE("*", "l_assets_type ", "  ORDER BY ASSETCODE+0 ")
        End If
    ...
    Private Sub BetterDisplayData(ByVal ds As DataSet)
        ...
        Try
            ...
            For i As Integer = 0 To ds.Tables(0).Rows.Count - 1
                ...
                BetterListView1.Items.Add(dr("ASSETCODE").ToString).AlignHorizontal = TextAlignmentHorizontal.Center

                BetterListView1.Items(i).SubItems.Add(dr("ASSETNAME").ToString).AlignHorizontal = TextAlignmentHorizontal.Left
                BetterListView1.Items(i).SubItems.Add(dr("STATUS_AF").ToString).AlignHorizontal = TextAlignmentHorizontal.Left
                BetterListView1.Items(i).SubItems.Add(dr("AGEUSED").ToString).AlignHorizontal = TextAlignmentHorizontal.Left
    ...
    Private Sub cmdEdit_Click(sender As Object, e As EventArgs) Handles cmdEdit.Click
        ...
        If CheckBox1.Checked = True Then
            tmpStatus = "0"
        End If
        clsbusent.Lc_BusinessEntity8.UpdateM_table("l_assets_type", "ASSETNAME = '" & txtDesc.Text & "',AGEUSED = '" & NumericUpDown1.Value.ToString & "',STATUS_AF = '" & tmpStatus & "'", "ASSETCODE = '" & txtCode.Text & "'")
    ...
    Private Sub cmdAdd_Click(sender As Object, e As EventArgs) Handles cmdAdd.Click
        ...
        Dim ds As DataSet
        ds = clsdataBus.Lc_Business8.SELECT_TABLE("*", "l_assets_type ", " WHERE  ASSETCODE = '" & txtCode.Text & "' ")
        If ds.Tables(0).Rows.Count > 0 Then
        ...
        Try
            clsbusent.Lc_BusinessEntity8.InsertM_table("l_assets_type (ASSETCODE,ASSETNAME,AGEUSED,STATUS_AF)",
        "'" & txtCode.Text & "','" & NumericUpDown1.Value.ToString & "','" & txtDesc.Text & "','1'")
            ClearData()
            searchData()
        Catch ex As Exception
            XtraMessageBox.Show("ไม่สามารถบันทึกได้เนื่องจากมีรหัสนี้แล้ว!!!", vProgram, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
    ...
    Private Sub BetterListView1_SelectedItemsChanged(sender As Object, eventArgs As BetterListViewSelectedItemsChangedEventArgs) Handles BetterListView1.SelectedItemsChanged
        For i As Integer = 0 To BetterListView1.SelectedItems.Count - 1
            ...
            End If
            NumericUpDown1.Value = lvi.SubItems.Item(3).Text
        Next
