...
Public Class frmTableBtype

    Private Sub frmTableBtype_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub searchData()
        ...
        If chkActive.Checked = True Then
            ds = clsdataBus.Lc_Business8.SELECT_TABLE("*", "l_btype ", " WHERE STATUS_AF = '1' ORDER BY BTYPECODE+0 ")
        ElseIf chkNonActive.Checked = True Then
            ds = clsdataBus.Lc_Business8.SELECT_TABLE("*", "l_btype ", " WHERE STATUS_AF = '0' ORDER BY BTYPECODE+0 ")
        Else
            ds = clsdataBus.Lc_Business8.SELECT_TABLE("*", "l_btype ", "  ORDER BY BTYPECODE+0 ")
        End If
    ...
    Private Sub BetterDisplayData(ByVal ds As DataSet)
        ...
        Try
            ...
            For i As Integer = 0 To ds.Tables(0).Rows.Count - 1
                ...
                BetterListView1.Items.Add(dr("BTYPECODE").ToString).AlignHorizontal = TextAlignmentHorizontal.Center

                BetterListView1.Items(i).SubItems.Add(dr("BTYPENAME").ToString).AlignHorizontal = TextAlignmentHorizontal.Left
    ...
    Private Sub cmdEdit_Click(sender As Object, e As EventArgs) Handles cmdEdit.Click
        ...
        If CheckBox1.Checked = True Then
            tmpStatus = "0"
        End If
        clsbusent.Lc_BusinessEntity8.UpdateM_table("l_btype", "BTYPENAME = '" & txtDesc.Text & "',STATUS_AF = '" & tmpStatus & "'", "BTYPECODE = '" & txtCode.Text & "'")
        ClearData()
        searchData()
    End Sub
    ...
    Private Sub cmdAdd_Click(sender As Object, e As EventArgs) Handles cmdAdd.Click
        ...
        Dim ds As DataSet
        ds = clsdataBus.Lc_Business8.SELECT_TABLE("*", "l_btype ", " WHERE  BTYPECODE = '" & txtCode.Text & "' ")
        If ds.Tables(0).Rows.Count > 0 Then
        ...
        Try
            clsbusent.Lc_BusinessEntity8.InsertM_table("l_btype (BTYPECODE,BTYPENAME,STATUS_AF)",
