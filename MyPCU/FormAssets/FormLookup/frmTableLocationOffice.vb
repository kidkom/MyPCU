...
Public Class frmTableLocationOffice

    Private Sub frmTableLocationOffice_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub searchData()
        ...
        If chkActive.Checked = True Then
            ds = clsdataBus.Lc_Business8.SELECT_TABLE("*", "l_location_office ", " WHERE STATUS_AF = '1' ORDER BY LOCATECODE+0 ")
        ElseIf chkNonActive.Checked = True Then
            ds = clsdataBus.Lc_Business8.SELECT_TABLE("*", "l_location_office ", " WHERE STATUS_AF = '0' ORDER BY LOCATECODE+0 ")
        Else
            ds = clsdataBus.Lc_Business8.SELECT_TABLE("*", "l_location_office ", "  ORDER BY LOCATECODE+0 ")
        End If
    ...
    Private Sub cmdEdit_Click(sender As Object, e As EventArgs) Handles cmdEdit.Click
        ...
        If CheckBox1.Checked = True Then
            tmpStatus = "0"
        End If
        clsbusent.Lc_BusinessEntity8.UpdateM_table("l_location_office", "LOCATENAME = '" & txtDesc.Text & "',STATUS_AF = '" & tmpStatus & "'", "LOCATECODE = '" & txtCode.Text & "'")
        ClearData()
        searchData()
    End Sub
    ...
    Private Sub cmdAdd_Click(sender As Object, e As EventArgs) Handles cmdAdd.Click
        ...
        Dim ds As DataSet
        ds = clsdataBus.Lc_Business8.SELECT_TABLE("*", "l_location_office ", " WHERE  LOCATECODE = '" & txtCode.Text & "' ")
        If ds.Tables(0).Rows.Count > 0 Then
        ...
        Try
            clsbusent.Lc_BusinessEntity8.InsertM_table("l_location_office (LOCATECODE,LOCATENAME,STATUS_AF)",
